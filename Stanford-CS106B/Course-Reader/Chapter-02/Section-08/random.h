 ...
 * File: random.h
 * --------------
 * This interface exports funcitons for generating pseudorandom numbers.
 */
#ifndef _random_h
#define _random_h
 ...
 * example, calling randomChance(0.30) returns true 30 percent of the time.
 */
